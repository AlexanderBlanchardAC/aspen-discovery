...
class Summon_Dashboard extends Admin_Dashboard {
	function launch() {
		global $interface;

		$instanceName = $this->loadInstanceInformation('SummonRecordUsage');
		$this->loadDates();
		...
		$this->display('dashboard.tpl', 'Summon Dashboard');
	}
	...
	public function getRecordStats($instanceName, $month, $year): array {
		...
		$usage->selectAdd('COUNT(summonId) as recordsUsed');
	...
	function getBreadcrumbs(): array {
		...
		$breadcrumbs[] = new Breadcrumb('/Admin/Home#summonhost', 'Summon');
		$breadcrumbs[] = new Breadcrumb('/Summon/Dashboard', 'Summon Usage Dashboard');
		return $breadcrumbs;
	}
