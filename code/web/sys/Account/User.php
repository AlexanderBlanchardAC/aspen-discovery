...
//						if($tmpResult['success']){$success++;}
	...
	public function getAdminActions() {
		...
		if (array_key_exists('Summon', $enabledModules)) {
			...
			$sections['summon']->addAction(new AdminAction('Settings', 'Define connection information between Summon and Aspen Discovery.', '/Summon/SummonSettings'), 'Administer SummonSettings');
