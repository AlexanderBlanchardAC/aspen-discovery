                    ...
                    <tbody>
                        {foreach from=$linkedUser.campaigns item="campaign" key="resultIndex"}
                            <tr>
                                ...
                                <td>
                                    <button onclick="toggleLinkedUserCampaignInfo('linkedUserCampaigns_{$resultIndex}');">{translate text="Campaign Information" isPublicFacing=true}</button>
                                </td>
                            </tr>
                                            ...
                                            {foreach from=$campaign.milestones item="milestone"}
                                                <tr>
                                                    ...
                                                    <td>
                                                        {$milestone.rewardName}
                                                        {if $milestone.rewardType ===1} 
                                                            <img src="{$milestone.badgeImage}" alt="{$milesotne.rewardName}" width="100" height="100" />
                                                        {/if}
                                                    </td>
                                                    <td>
                                                        {$milestone.completedGoals} / {$milestone.totalGoals}
